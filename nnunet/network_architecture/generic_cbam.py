...
class Generic_cbam(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_cbam, self).__init__()
        ...
        for d in range(num_pool):
            ...
            self.cbam.append(CBAM(output_features, num_pool - d + 1))
...
if __name__ == '__main__':
    ...
    macs, params = profile(Generic_BTS_Netv5_2(4, 32, 3, 5), inputs=(input,))

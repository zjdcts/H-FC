...
from nnunet.training.loss_functions.dice_loss import DC_and_CE_loss, SoftDiceLoss, DC_and_Focal_loss
from nnunet.training.network_training.network_trainer import NetworkTrainer
from nnunet.utilities.nd_softmax import softmax_helper
from nnunet.utilities.tensor_utilities import sum_tensor
from torch.optim import lr_scheduler
from nnunet.network_architecture.generic_PointRend_Net import point_sample, sampling_points
...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.oversample_foreground_percent = 0.43
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, do_mirroring: bool = True,
        ...
        self.network.eval()
        print('!!!', self.regions_class_order)
        ...
        for k in self.dataset_val.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                if data.shape[0] == 5:
                    ...
                    softmax_pred = self.predict_preprocessed_data_return_seg_and_softmax(data[:-4],
                                                                                         do_mirroring=do_mirroring,
                                                                                         mirror_axes=mirror_axes,
                                                                                         use_sliding_window=use_sliding_window,
                                                                                         step_size=step_size,

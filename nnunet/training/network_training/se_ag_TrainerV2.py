...
from nnunet.network_architecture.generic_se_ag import Generic_se_ag
...
class se_ag_TrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_se_ag(self.num_input_channels, self.base_num_features, self.num_classes,

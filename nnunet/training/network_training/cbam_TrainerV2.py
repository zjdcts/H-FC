...
from nnunet.network_architecture.generic_cbam import Generic_cbam
...
class cbam_TrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_cbam(self.num_input_channels, self.base_num_features, self.num_classes,

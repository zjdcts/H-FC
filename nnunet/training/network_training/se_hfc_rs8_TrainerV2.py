...
from nnunet.network_architecture.generic_se_hfc_rs8 import Generic_se_hfc_rs8
...
class se_hfc_rs8_TrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_se_hfc_rs8(self.num_input_channels, self.base_num_features, self.num_classes,

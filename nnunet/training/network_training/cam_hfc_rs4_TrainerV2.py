...
from nnunet.network_architecture.generic_cam_hfc_rs4 import Generic_cam_hfc_rs4
...
class cam_hfc_rs4_TrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_cam_hfc_rs4(self.num_input_channels, self.base_num_features, self.num_classes,

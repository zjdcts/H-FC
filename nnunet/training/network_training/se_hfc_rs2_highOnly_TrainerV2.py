...
from nnunet.network_architecture.generic_se_hfc_rs2_highOnly import Generic_se_hfc_rs2_highOnly
...
class se_hfc_rs2_highOnly_TrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_se_hfc_rs2_highOnly(self.num_input_channels, self.base_num_features, self.num_classes,
